...
| Build Windows Setup installer (Inno Setup 6; ISCC auto-located, override with `ISCC_PATH`) | `npm run build:installer` |
...
src/
  ...
  core/
    ...
    audit-actions.ts        Audit action enum (162 actions)
