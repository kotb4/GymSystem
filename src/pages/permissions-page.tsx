...
const PERM_GROUPS = [
  ...
  { label: "الاشتراكات", perms: ["subscriptions.view","subscriptions.create","subscriptions.edit","subscriptions.cancel","subscriptions.freeze"] as Permission[] },
  { label: "الحضور والانصراف", perms: ["checkin.create","checkin.view_history","checkin.checkout"] as Permission[] },
  ...
  { label: "الخزينة", perms: ["cash.open","cash.close"] as Permission[] },
  { label: "التقارير", perms: ["reports.view","reports.export"] as Permission[] },
  { label: "المتجر", perms: ["store.view","store.products","store.sell","store.credit","store.repayments","store.void_sale","store.inventory","store.profit"] as Permission[] },
  ...
  { label: "الموظفون والرواتب", perms: ["employees.view","employees.manage","salaries.view","salaries.manage"] as Permission[] },
