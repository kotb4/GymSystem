...
- **Current objective (done, this session):** **TASK-036 — the three approved follow-ups «اعمل كلو»**: **F1** license anti-rollback marker (TASK-031 Phase-3 hardening, ADR-021), **F2** standalone Referrals page (`/referrals`), **F3** purge photo-byte cleanup (audit F-05, now CLOSED with a regression test).
