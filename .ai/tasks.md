...
- Follow-up (optional): remove legacy `/users`,`/permissions`,`/health`,`/scanner`,`/reception`,`/packages` routes from `routes/index.tsx` once confirmed unused by operators.
