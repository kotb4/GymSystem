...
- Status: done (2026-09-02) — all phases complete + pushed; verification green
...
- Follow-up (optional): remove legacy `/users`,`/permissions`,`/health`,`/scanner`,`/reception`,`/packages`,`/cash` routes from `routes/index.tsx` once confirmed unused by operators. Also `docs/ai/roadmap.md` may list خزينة النادي + الإغلاق اليومي as separate pages — now merged under `/treasury`.
