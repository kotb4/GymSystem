...
- Follow-up (optional): remove legacy `/users`,`/permissions`,`/health`,`/scanner`,`/reception` routes from `routes/index.tsx` once confirmed unused by operators.
