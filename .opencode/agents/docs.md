...
- `AGENTS.md`
- `.ai/current-state.md`, `.ai/project.md`, `.ai/architecture.md`, `.ai/business-rules.md`, `.ai/decisions.md`, `.ai/tasks.md`, `.ai/audits/**`
- `docs/ai/**`
...
Note: `.ai/current-state.md` is **human/agent-maintained** and is the live handoff between coding agents. It is NOT auto-generated by `scripts/sync-docs.mjs` (which only updates machine-verifiable counts/versions in `AGENTS.md`, `.ai/project.md`, `docs/ai/architecture.md`, `docs/ai/database.md`).

## Mandatory process

1. Read `AGENTS.md` and the target `.ai/` file. Read `.ai/current-state.md` to know what's been recently changed.
