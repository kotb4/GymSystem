...
export const classes = defineService({
  ...
  createClassRecurrence: a(classesService.createClassRecurrence as Fn),
  listClassRecurrences: a(classesService.listClassRecurrences as Fn),
  generateRecurrenceWeeks: a(classesService.generateRecurrenceWeeks as Fn),
  deactivateClassRecurrence: a(classesService.deactivateClassRecurrence as Fn),
